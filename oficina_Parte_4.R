...
hist(DTM.H, breaks=20, prob=T, xlim=c(-6,6)) # mudar escala x e apresentar a densidade da probabilidade em vez das frequencias

# Exercicio 01: 
# fazer o histograma da variável (H), 
...
# Exercicio 02: 
# Mude a orientação do boxplot, 
# coloque cores diferentes nos três e 
# adicione uma linha transversal de valor 0, cor vermelha e espessura 2. 
...
# Exercicio 03:  
# Ajustar limites eixo y, mudar o tipo e cor de cada conjunto de pontos 
# ver (?points). 
# Coloque nomes nos eixos e no gráfico. 
# Adicione uma legenda (?legend).
...
# Exercicio 04:  
# Colocar titulo principal e em cada eixo, mudar o tipo, cor e tamanho dos pontos. 
...
# A forma mais simples de quantificar a correlação é através da função "cor" do R, ver ?cor.
...
# Observe que incluimos o argumento use="complete.obs" já que existe ausência de valores no 
