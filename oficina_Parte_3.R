...
# ---
  ...
  ## Gráficos com a função genérica _plot_
...
set.seed(12345) # semente serve para reprodução de valores iguais em dados randómicos (ou  seudo...)
...
# a cor e o símbolo são simples de mudar com _col_ e _pch_ 
...
# O tamanho do símbolo pode ser mudado com _cex_, experimente valores como 2 e 0.5
plot(x, y, 
     xlab="Sequencial", 
     ylab="Valores", 
     col="red", 
...
# os limites dos eixos podem ser estabelecidos com _xlim_ e _ylim_
plot(x, y, 
     xlab="Sequencial", 
     ylab="Valores", 
     col="red", 
...
par(pro) # voltamos aos valores padrao de cada parametro
...
# Uma funcao muito útil para ter mais controle dos eixos é  _axis_.
...
par(pro) # voltamos aos valores padrao..
plot(x,y,
...
# a funcao tambem controla a linha e espessura das marcas
par(pro)
plot(x,y,
     xaxt = "n",
     yaxt = "n")
...
#   
#   Se tem um controle mais fino atraves de par ou axis:
#   
...
#   
#  - o primeiro controla o afastamento entre o grafico e o eixo do titulo
# 
#  - o segundo entre o grafico e o eixo de etiquetas e 
# 
#  - o terceiro entre o grafico e a linha do eixo,
# 
...
# Vejamos o caso quando temos uma area de plotagem com varios graficos e eixos semelhantes...
...
# Um outro tipo de grafico, o histograma
par(pro)
set.seed(123)
# geramos duas amostras normais, com parametros diferentes, veja ?_rnorm_
x <- rnorm(500, 8, 5)
y <- rnorm(500, 0, 2)
...
# Geramos uma distribuicao normal assimetrica a direita
z <- cbind(x,y)
...
# 
# O pacote RColorBrewer cria cores ou niveis de cinza atraves de gray(). 
# 
# Exemp: gray(0:10/15) produz 10 niveis de cinza.
# 
# 
# Finalmente alguns titulos nos eixos, convenientemente colocados para nao atrapalhar
# ver opcoes de _plot_ e _par_
# 
